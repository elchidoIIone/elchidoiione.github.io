...
require "./php/bd.php"; 
$name = "Phonics"; // Nombre para el Header
$currentSubjectID = 2; 
...
<head>
    ...
    <title>Phonics Dashboard</title> <!-- Título corregido -->
...
<body>
                ...
                <div id="schlInputs">
                    ...
                    <form action="./php/saveActivity.php" method="POST">
                        <fieldset>
                            ...
                            <!-- CORRECCIÓN CLAVE: INPUT DE REDIRECCIÓN -->
                            <input type="hidden" name="redirect" value="../phonics.php">
                            ...
                            <?php foreach ($students as $stu): ?>
                                ...
                                <tr class="student-row">
                                    ...
                                    <td class="average-cell" style="font-weight: bold;">
                                        <?php echo ($cantidad > 0) ? number_format($suma / $cantidad, 1) : "-"; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <!-- SCRIPT JS IGUAL AL DE SPELLING -->
    <script>
